...
public class MisOpiniones extends AppCompatActivity {
    private RecyclerView recyclerView;
    private ReseñaAdapter adapter;
    private List<Reseña> listaCompleta;
                                        ...
                                        .addOnCompleteListener(professorTask -> {
                                            if (professorTask.isSuccessful()) {
                                                ...
                                                if (professorDoc.exists()) {
                                                    ...
                                                    lista.add(new Reseña(calificacion, comentario, profesorNombre, userId, materia));
